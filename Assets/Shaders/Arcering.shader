...
////// Emissive:
                ...
                float3 emissive = (((_Color.rgb*_ColorMap_var.rgb)-(((((1.0 - node_6794.rgb)*step(node_25,node_1675))+((1.0 - node_931.rgb)*step(node_25,_ShadowThreshhold)))*node_9673*_ShadowIntensity)+(step(node_25,(node_8201*node_1675))*node_9673*_BlackSpotIntensity)))/(1.0 - (step(_LightThreshhold,node_25)*_HighlighIntensity)));
...
////// Lighting:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 node_931 = tex2D(_Pattern,TRANSFORM_TEX(float2((sceneUVs.x * 2 - 1)*(_ScreenParams.r/_ScreenParams.g), sceneUVs.y * 2 - 1).rg, _Pattern));
                float node_9673 = (1.0 - node_25);
                o.Emission = (((_Color.rgb*_ColorMap_var.rgb)-(((((1.0 - node_6794.rgb)*step(node_25,node_1675))+((1.0 - node_931.rgb)*step(node_25,_ShadowThreshhold)))*node_9673*_ShadowIntensity)+(step(node_25,(node_8201*node_1675))*node_9673*_BlackSpotIntensity)))/(1.0 - (step(_LightThreshhold,node_25)*_HighlighIntensity)));
